...
export interface IAdminUserRepository {
  ...
  updateAdminById(id: string, updateData: Partial<IAdminUser>): Promise<IAdminUser | null>;
}
...
export class AdminUserRepository implements IAdminUserRepository {
  ...
  async updateAdminById(id: string, updateData: Partial<IAdminUser>): Promise<IAdminUser | null> {
    return await AdminUserModel.findByIdAndUpdate(id, updateData, { new: true });
  }
}
